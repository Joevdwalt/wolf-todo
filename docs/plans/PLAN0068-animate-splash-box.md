...
then vertically. The controls gallery demonstrates the animation as a
fullscreen sixth example; Wtodo startup remains unchanged.

## Delivered

- Host-timed, two-phase cubic ease-out expansion at approximately 30 FPS, with
